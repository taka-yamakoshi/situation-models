...
d.zindiv <- preprocess(d.zindiv.raw)
d.qry <- preprocess(d.qry.raw)
d.key <- preprocess(d.key.raw)
d.val <- preprocess(d.val.raw)
```
...
#for (plot_head_id in c(3,8,11,16,17,21,23,24,26,28,29,35,37,40,42,45,46,48,50,51,53,55,56,58,60)) {
  for (plot_cue_type in c("context","verb")) {
    ...
    ggsave(here(paste0('results/figures/headwise/all/alpha/head_',plot_head_id,'_',plot_cue_type,'.pdf',sep="")), units = 'in', width = 7.5, height = 3.6)
  }
}
```
...
ggsave(paste('supps/zrep_all_',plot_cue_type,'.pdf',sep=""), units = 'in', width = 16, height = 16)
}
```
...
d.val %>%
  ...
  ggplot(aes(x = as.factor(layer_id), y = empirical_stat, color = pos_type, group = pos_type)) +
    ...
    theme(aspect.ratio = 1,legend.position = 'top', legend.title = element_blank(), 
          axis.text.x=element_text(size=7),axis.text.y=element_text(size=10), axis.title=element_text(size=16),
          strip.text=element_text(size=10), legend.text=element_text(size=16))
ggsave(paste('supps/value_all_',plot_cue_type,'.pdf',sep=""), units = 'in', width = 16, height = 16)
}
```
...
d.qry %>%
  ...
  ggplot(aes(x = as.factor(layer_id), y = empirical_stat, color = pos_type, group = pos_type)) +
    ...
    theme(aspect.ratio = 1,legend.position = 'top', legend.title = element_blank(), 
          axis.text.x=element_text(size=7),axis.text.y=element_text(size=10), axis.title=element_text(size=16),
          strip.text=element_text(size=10), legend.text=element_text(size=16))
ggsave(paste('supps/query_all_',plot_cue_type,'.pdf',sep=""), units = 'in', width = 16, height = 16)
}
```
...
d.key %>%
  ...
  ggplot(aes(x = as.factor(layer_id), y = empirical_stat, color = pos_type, group = pos_type)) +
    ...
    theme(aspect.ratio = 1,legend.position = 'top', legend.title = element_blank(), 
          axis.text.x=element_text(size=7),axis.text.y=element_text(size=10), axis.title=element_text(size=16),
          strip.text=element_text(size=10), legend.text=element_text(size=16))
ggsave(paste('supps/key_all_',plot_cue_type,'.pdf',sep=""), units = 'in', width = 16, height = 16)
}
```