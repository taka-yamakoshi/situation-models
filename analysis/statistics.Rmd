...
d %>%
  ...
  filter(position %in% c('context','verb','options', 'masks')) %>%
  mutate(condition=factor(condition,levels=c('context','verb','context+verb'))) %>%
  mutate(position=factor(position,levels=c('context','verb','options','masks'))) %>%
  ...
  ggplot(aes(x = as.factor(layer_id), y = empirical_stat, color = position, group = position)) +
    ...
    #scale_linetype_manual(values=c("solid", "twodash","solid","solid"))+
...
d %>%
  ...
  ggplot(aes(x = as.factor(layer_id), y = empirical_stat, color = position, group = position)) +
    ...
    theme(aspect.ratio = 1,legend.position = 'top', legend.title = element_blank(), 
          axis.text.x=element_text(size=10),axis.text.y=element_text(size=14), axis.title=element_text(size=18),
          strip.text=element_text(size=16), legend.text=element_text(size=16)) +
ggsave('layer_incorrect.pdf', units = 'in', width = 9, height = 4)
```
...
d.zrep %>%
  filter(original_score) %>%
  filter(position %in% c('options', 'masks')) %>%
  mutate(condition=factor(condition,levels=c('context','verb'))) %>%
  mutate(position=factor(position,levels=c('options','masks'))) %>%
  group_by(condition, layer_id, position) %>%
  #summarize(effect_ave = mean(effect_ave)) %>%
  tidyboot_mean(effect_ave, nboot = 1000) %>%
  ggplot(aes(x = as.factor(layer_id), y = empirical_stat, color = position, group = position)) +
...
d.head_7 <- bind_rows(d.val %>%
                        filter(head_id == 7) %>%
                        filter(pos_type %in% c("context","verb")),
                      d.zindiv %>%
                        filter(head_id == 7) %>%
...
d.head_7 %>%
  ...
  ggplot(aes(x = as.factor(layer_id), y = empirical_stat, color = rep_type, group = rep_type, linetype = rep_type)) +
    ...
    theme(aspect.ratio = 1,legend.position = 'top', legend.title = element_blank(),
          axis.text.x=element_text(size=10),axis.text.y=element_text(size=14), axis.title=element_text(size=18),
          strip.text=element_text(size=16), legend.text=element_text(size=16)) +
ggsave('head_8_context.pdf', units = 'in', width = 3, height = 4)
```
...
d.head_7 %>%
  ...
  ggplot(aes(x = as.factor(layer_id), y = empirical_stat, color = rep_type, group = rep_type, linetype = rep_type)) +
    ...
    theme(aspect.ratio = 1,legend.position = 'top', legend.title = element_blank(),
          axis.text.x=element_text(size=10),axis.text.y=element_text(size=14), axis.title=element_text(size=18),
          strip.text=element_text(size=16), legend.text=element_text(size=16)) +
ggsave('head_8_verb.pdf', units = 'in', width = 3, height = 4)
```
...
d.head_10 %>%
  ...
  ggplot(aes(x = as.factor(layer_id), y = empirical_stat, color = rep_type, group = rep_type, linetype = rep_type)) +
    ...
    theme(aspect.ratio = 1,legend.position = 'top', legend.title = element_blank(),
          axis.text.x=element_text(size=10),axis.text.y=element_text(size=14), axis.title=element_text(size=18),
          strip.text=element_text(size=16), legend.text=element_text(size=16)) +
ggsave('head_11_context.pdf', units = 'in', width = 3, height = 4)
```
...
d.head_18 %>%
  ...
  ggplot(aes(x = as.factor(layer_id), y = empirical_stat, color = rep_type, group = rep_type, linetype = rep_type)) +
    ...
    theme(aspect.ratio = 1,legend.position = 'top', legend.title = element_blank(),
          axis.text.x=element_text(size=10),axis.text.y=element_text(size=14), axis.title=element_text(size=18),
          strip.text=element_text(size=16), legend.text=element_text(size=16)) +
ggsave('head_19_verb.pdf', units = 'in', width = 3, height = 4)
```
...
d.head_44 %>%
  ...
  ggplot(aes(x = as.factor(layer_id), y = empirical_stat, color = rep_type, group = rep_type, linetype = rep_type)) +
    ...
    theme(aspect.ratio = 1,legend.position = 'top', legend.title = element_blank(), 
          axis.text.x=element_text(size=10),axis.text.y=element_text(size=14), axis.title=element_text(size=18),
          strip.text=element_text(size=16), legend.text=element_text(size=16)) +
ggsave('head_45_context.pdf', units = 'in', width = 3, height = 4)
```
...
d.head_44 %>%
  ...
  ggplot(aes(x = as.factor(layer_id), y = empirical_stat, color = rep_type, group = rep_type, linetype = rep_type)) +
    ...
    theme(aspect.ratio = 1,legend.position = 'top', legend.title = element_blank(), 
          axis.text.x=element_text(size=10),axis.text.y=element_text(size=14), axis.title=element_text(size=18),
          strip.text=element_text(size=16), legend.text=element_text(size=16)) +
ggsave('head_45_verb.pdf', units = 'in', width = 3, height = 4)
```
...
d.head_47 %>%
  ...
  ggplot(aes(x = as.factor(layer_id), y = empirical_stat, color = rep_type, group = rep_type, linetype = rep_type)) +
    ...
    theme(aspect.ratio = 1,legend.position = 'top', legend.title = element_blank(), 
          axis.text.x=element_text(size=10),axis.text.y=element_text(size=14), axis.title=element_text(size=18),
          strip.text=element_text(size=16), legend.text=element_text(size=16)) +
ggsave('head_48_context.pdf', units = 'in', width = 3, height = 4)
```
...
d.head_47 %>%
  ...
  ggplot(aes(x = as.factor(layer_id), y = empirical_stat, color = rep_type, group = rep_type, linetype = rep_type)) +
    ...
    theme(aspect.ratio = 1,legend.position = 'top', legend.title = element_blank(), 
          axis.text.x=element_text(size=10),axis.text.y=element_text(size=14), axis.title=element_text(size=18),
          strip.text=element_text(size=16), legend.text=element_text(size=16)) +
ggsave('head_48_verb.pdf', units = 'in', width = 3, height = 4)
```


## Comprehensive Results for Supplementary
```{r}
d.head_all <- bind_rows(d.val%>%filter(pos_type%in%c('context','verb')),d.qnk) %>%
  mutate(layer_id=layer_id+1) %>%
  mutate(head_id=head_id+1) %>%
...
d.head_all %>%
  filter(original_score) %>%
  filter(cue_type=='context') %>%
  mutate(pos_type=factor(pos_type,levels=c('context','verb','masks-options','options-masks'))) %>%
  ...
  ggplot(aes(x = as.factor(layer_id), y = empirical_stat, color = pos_type, group = pos_type)) +
    ...
    geom_errorbar(aes(ymin=ci_lower, ymax=ci_upper), width=0.1,size=0.8,linetype='solid',position = position_dodge(width = 0.3)) +
    scale_color_manual(values=c("#E69F00","#D55E00","#CC79A7","#0072B2")) +
...
ggsave('head_all_context.pdf', units = 'in', width = 16, height = 16)
```
...
d.head_all %>%
  ...
  ggplot(aes(x = as.factor(layer_id), y = empirical_stat, color = pos_type, group = pos_type)) +
    ...
    theme(aspect.ratio = 1,legend.position = 'top', legend.title = element_blank(), 
          axis.text.x=element_text(size=7),axis.text.y=element_text(size=10), axis.title=element_text(size=16),
          strip.text=element_text(size=10), legend.text=element_text(size=16)) +
ggsave('head_all_verb.pdf', units = 'in', width = 16, height = 16)
```
...
d.zrep_all %>%
  ...
  ggplot(aes(x = as.factor(layer_id), y = empirical_stat, color = pos_type, group = pos_type)) +
    ...
    theme(aspect.ratio = 1,legend.position = 'top', legend.title = element_blank(), 
          axis.text.x=element_text(size=7),axis.text.y=element_text(size=10), axis.title=element_text(size=16),
          strip.text=element_text(size=10), legend.text=element_text(size=16)) +
ggsave('zrep_all_context.pdf', units = 'in', width = 16, height = 16)
```
...
d.zrep_all %>%
  ...
  ggplot(aes(x = as.factor(layer_id), y = empirical_stat, color = pos_type, group = pos_type)) +
    ...
    theme(aspect.ratio = 1,legend.position = 'top', legend.title = element_blank(), 
          axis.text.x=element_text(size=7),axis.text.y=element_text(size=10), axis.title=element_text(size=16),
          strip.text=element_text(size=10), legend.text=element_text(size=16)) +
ggsave('zrep_all_verb.pdf', units = 'in', width = 16, height = 16)
```
